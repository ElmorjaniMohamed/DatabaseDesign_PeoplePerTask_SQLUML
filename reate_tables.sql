-- Active: 1700748913300@@127.0.0.1@3306@peoplepertask
...
CREATE TABLE IF NOT EXISTS Offers (
    ...
    FreelancerID INT,
    ProjectID INT,
    FOREIGN KEY (FreelancerID) REFERENCES Freelancers(FreelancerID) ON DELETE
    SET NULL ON UPDATE CASCADE,
        FOREIGN KEY (ProjectID) REFERENCES Projects(ProjectID) ON DELETE
    SET NULL ON UPDATE CASCADE
);
